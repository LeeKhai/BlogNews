...
<div class="tab sitebar">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="1">
            <div class="media">
                <div class="media-left">
                    <a href="#"><img class="media-object" src="{{asset('welcome/img/img-list.jpg')}}" alt="Generic placeholder image"></a>
                </div><!--media-left-->
        ...
        <div class="tab-pane" id="2">
            <div class="media">
                <div class="media-left">
                    <a href="#"><img class="media-object" src="{{asset('welcome/img/img-list4.jpg')}}" alt="Generic placeholder image"></a>
                </div><!--media-left-->
                <div class="media-body">
                    <h3 class="media-heading"><a href="#">Spain going to made class football</a></h3>
                    <span class="rating">
...
<div class="ad">
    <img class="img-responsive" src="{{asset('welcome/img/img-sitebar.jpg')}}" alt="img" />
    <img class="img-responsive" src="{{asset('welcome/img/img-sitebar.jpg')}}" alt="img" />
    <img class="img-responsive" src="{{asset('welcome/img/img-sitebar.jpg')}}" alt="img" />
    <img class="img-responsive" src="{{asset('welcome/img/img-sitebar.jpg')}}" alt="img" />
</div><!--ad-->
...
<div class="ad">
    <img class="img-responsive" src="{{asset('welcome/img/img-ad.jpg')}}" alt="img" />
</div>

<div class="ad">
    <img class="img-responsive" src="{{asset('welcome/img/img-ad2.jpg')}}" alt="img" />
</div>
