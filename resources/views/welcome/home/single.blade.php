				...
				<div class="single_content_layout">
					...
					<div class="readers_comment">
						...
						<div class="media">
							<div class="media-left">
								<a href="#">
									<img alt="64x64" class="media-object" data-src="{{asset('welcome/img/img-author1.jpg')}}"
										 src="{{asset('welcome/img/img-author1.jpg')}}" data-holder-rendered="true">
								</a>
							</div>
							<div class="media-body">
								...
								<div class="media reply">
									<div class="media-left">
										<a href="#">
											<img alt="64x64" class="media-object" data-src="{{asset('welcome/img/img-author2.jpg')}}"
												 src="{{asset('welcome/img/img-author2.jpg')}}" data-holder-rendered="true">
										</a>
									</div>
									<div class="media-body">
