                ...
                <div class="item active feature_news_item">
                  <div class="item_wrapper">
                    <div class="item_img">
                      <img
                        class="img-responsive"
                        v-bind:src="pathImage('img-hockey.jpg')"
                        alt="Chania"
                      >
                    </div>
                    <div class="item_title_date">
                  ...
                  <div class="media">
                    <div class="media-left">
                      <a href="#">
                        <img
                          class="media-object"
                          v-bind:src="pathImage('img-list5.jpg')"
                          alt="Generic placeholder image"
                        >
                      </a>
                    </div>
                  ...
                  <div class="media">
                    <div class="media-left">
                      <a href="#">
                        <img
                          class="media-object"
                          v-bind:src="pathImage('img-list6.jpg')"
                          alt="Generic placeholder image"
                        >
                      </a>
                    </div>
                  ...
                  <div class="media">
                    <div class="media-left">
                      <a href="#">
                        <img
                          class="media-object"
                          v-bind:src="pathImage('img-list7.jpg')"
                          alt="Generic placeholder image"
                        >
                      </a>
                    </div>
                  ...
                  <div class="media">
                    <div class="media-left">
                      <a href="#">
                        <img
                          class="media-object"
                          v-bind:src="pathImage('img-list8.jpg')"
                          alt="Generic placeholder image"
                        >
                      </a>
                    </div>
                  ...
                  <div class="media">
                    <div class="media-left">
                      <a href="#">
                        <img
                          class="media-object"
                          v-bind:src="pathImage('img-list9.jpg')"
                          alt="Generic placeholder image"
                        >
                      </a>
                    </div>
                  ...
                  <div class="item">
                    <div class="item_wrapper">
                      <div class="item_img">
                        <img
                          class="img-responsive"
                          v-bind:src="pathImage('img-news.jpg')"
                          alt="Chania"
                        >
                      </div>
                      <div class="item_title_date">
                  ...
                  <div class="item active">
                    <div class="item_wrapper">
                      <div class="item_img">
                        <img
                          class="img-responsive"
                          v-bind:src="pathImage('img-news1.jpg')"
                          alt="Chania"
                        >
                      </div>
                      <div class="item_title_date">
                  ...
                  <div class="item active">
                    <div class="item_wrapper">
                      <div class="item_img">
                        <img
                          class="img-responsive"
                          v-bind:src="pathImage('img-news2.jpg')"
                          alt="Chania"
                        >
                      </div>
                      <div class="item_title_date">
