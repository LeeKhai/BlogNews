  ...
  <div class="col-md-3">
    <div class="tab sitebar">
      <ul class="nav nav-tabs">
        <li class="active">
          <a href="#1" data-toggle="tab">Latest</a>
        </li>
        <li>
    ...
    <div class="ad">
      <img class="img-responsive" v-bind:src="pathImage('img-sitebar.jpg')" alt="img">
      <img class="img-responsive" v-bind:src="pathImage('img-sitebar.jpg')" alt="img">
      <img class="img-responsive" v-bind:src="pathImage('img-sitebar.jpg')" alt="img">
      <img class="img-responsive" v-bind:src="pathImage('img-sitebar.jpg')" alt="img">
    </div>
    ...
    <div class="ad">
      <img class="img-responsive" v-bind:src="pathImage('img-ad.jpg')" alt="img">
    </div>
